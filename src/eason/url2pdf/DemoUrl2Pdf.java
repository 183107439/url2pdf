...
public class DemoUrl2Pdf {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 直接把网页内容转为PDF文件
        String pdfFile = "itext/demo-URL.pdf";
        DemoUrl2Pdf.parseURL2PDFFile(pdfFile, blogURL);

        // 把网页内容转为PDF中的Elements
//        String pdfFile2 = "itext/demo-URL2.pdf";
//        DemoUrl2Pdf.parseURL2PDFElement(pdfFile2, blogURL);
    }
